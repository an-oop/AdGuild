...
/*
	  ...
	  // A: Send the file to the HTTP cloud server
      {
	  	...
	  	xhr.open('GET', 'C:\Users\Lenovo\Downloads\abc1.png', true);

	  	alert('Great!!! All supported');
...
/*
	  {
		  ...
		  xhr.open('GET', 'http://localhost/abc1.png', false);

		  alert('something did succeed');
...
*/
	  ...
	  if(1 == count)
	  {
	  	document.getElementById("youtubeVideo").src = 'http://www.youtube.com/embed/PDvHEA-LFQM?autoplay=1';
	  }
	  else if(2 == count)
	  {
	  	document.getElementById("youtubeVideo").src = 'http://www.youtube.com/embed/U9HCa6SCql0?autoplay=1';
	  }
	  else
	  {
		document.getElementById("youtubeVideo").src = 'http://www.youtube.com/embed/pDhHQsbZ820?autoplay=1';
		count = 0;
	  }
