...
class Facepp
{
    ...
    public $api_key         = 'd6e78f360228334aae60870c868a6ade';        // set your API KEY or set the key static in the property
    public $api_secret      = 'hL09r8LdYTfOYxG-SCVXFtTIQ-nvlk4a';        // set your API SECRET or set the secret static in the property
